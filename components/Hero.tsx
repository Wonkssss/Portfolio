      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          ...
          <TextGenerateEffect 
            ...
            words="Computer Science and Creative technology student at ESILV"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hello, I&apos;m Wiam, and I am a curious individual eager to contribute to meaningful projects while continuously learning and expanding my skills.
          </p>
